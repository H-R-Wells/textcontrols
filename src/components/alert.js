...
export default function Alert(props) {
    return (
        ...
        <div className='flex justify-center w-full'>
            <div className={` flex absolute  justify-center w-5/6 items-center m-1 font-medium py-1 px-2 bg-green-300 rounded-md text-black  border border-green-700 ${props.alertHide} `}>
                <div slot="avatar">
