    ...
    return (
        <div className='md:flex min-w-full justify-center w-full container bg-slate-400 pb-12'>
            ...
            <div className="flex w-full max-w-lg bg-slate-400 justify-center py-12">
                ...
                <div className="mx-8 block container max-w-xs px-9 py-10 md:px-12 lg:py-12 rounded-lg shadow-lg bg-white w-full lg:max-w-2xl">
                    <form>
            ...
            <div className=" justify-center px-5 text-left pt-8 pb-12 bg-slate-200 md:block md:container  py-0 md:px-12 md:py-12 rounded-lg shadow-lg md:my-12  md:max-w-lg mx-8">
                <div className='container '>
                    <h1 className='font-semibold text-4xl text-black'>Your Text Summary</h1>
